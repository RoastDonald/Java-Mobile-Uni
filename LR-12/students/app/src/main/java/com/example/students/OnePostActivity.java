...
public class OnePostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String res =  new HttpDataGetter("http://jsonplaceholder.typicode.com/posts/" + Integer.toString(postId)).getData();
        try{
            ...
            String resUser = new HttpDataGetter("http://jsonplaceholder.typicode.com/users/" + user_id).getData();
