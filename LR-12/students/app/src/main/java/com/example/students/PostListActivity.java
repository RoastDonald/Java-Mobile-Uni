...
public class PostListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<Post> adapter = new ArrayAdapter<Post>(
                this,
        ...
        AdapterView.OnItemClickListener listener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(PostListActivity.this, OnePostActivity.class);
    ...
    private ArrayList<Post> getListData(){
        ...
        String res = new HttpDataGetter("http://jsonplaceholder.typicode.com/posts/").getData();
        try{
